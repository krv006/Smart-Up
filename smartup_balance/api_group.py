...
def fetch_balance_chunks(filial_warehouse_list, begin_date: datetime, end_date: datetime):
    """API dan ma'lumotlarni olib keladi, dublikatlarni chiqarib tashlaydi va fact/group uchun massiv qaytaradi."""
...
def main():
    ...
    fact_rows, group_rows = fetch_balance_chunks(filial_warehouse_list, begin_date, end_date)
    if not fact_rows:
